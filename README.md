...
The deployment uses one SQLite replica. The deployment gate checks private links, submission, and teacher review. It repeats those checks after replacing the production revision. The deployment-policy claim tests the topology and this failure gate.
