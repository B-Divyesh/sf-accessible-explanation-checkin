...
The deployment uses one SQLite replica. It finishes only after repeated cross-connection private-link reads, a student submission, a saved teacher review, and replacement by a new production revision all pass. The deployment-policy claim tests the topology and this failure gate.
