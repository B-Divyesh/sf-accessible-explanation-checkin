# Accessible Explanation Check-in (`accessible-explanation-checkin`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://accessible-explanation-checkin.sociobot.in`. Artifact class: `web-with-backend`.
